...
<template>
    <ActionSection>
        ...
        <template #description>
            Управляйте и завершайте активные сессии на других устройствах и браузерах.
        </template>

        <template #content>
            <div class="max-w-xl text-sm text-gray-600">
                Если необходимо, вы можете завершить сессии на всех устройствах.Некоторые активные сессии приведены ниже,впрочем этот список может быть неактуальным.
                Если данные вашего аккаунта были скомпрометированы, также следует сменить пароль.
            </div>
